...
int(numero_01)+ int(numero_02)+ int(numero_03)+ int(numero_04)
...
# COMPLETAR - INICIO
suma_de_numeros = str(numero_01)+ str(numero_02) +str(numero_03)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
resultado_resta = int(numero_01)- int(numero_02,16)- int(numero_03,16)- numero_04 
#el 4 ya es entero se deja asi como esta, no se cambia
